...
def load_or_store_model(func, *args, **kwargs):
    """
    Wrapper to check whether the model is already saved to return saved model instead of new training
    Function must have a save_to location and recompute option defined
    """
